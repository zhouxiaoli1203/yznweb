    ...
    return ['$scope', '$rootScope', '$http', '$state', '$stateParams','$timeout', function($scope, $rootScope, $http, $state, $stateParams,$timeout) {
        ...
        function init(){
            ...
            $scope.screen_classType = [
             ...
             $scope.teacListThead = [
                {'name': '物品名称','width': '100px',},
                {'name': '售卖数量','width': '10%', 'issort': true,id:"data2",},
                {'name': '售卖金额','width': '10%', 'issort': true,id:"data3"},
                {'name': '退学杂数量','width': '10%', 'issort': true,id:"data5"},
                {'name': '退学杂金额','width': '10%', 'issort': true,id:"data6",},
                {'name': '成本价格','width': '10%', 'issort': true,id:"data4",},
                {'name': '损耗数量','width': '10%', 'issort': true,id:"data7"},
                {'name': '损耗金额','width': '10%', 'issort': true,id:"data8"},
                {'name': '利润','width': '10%', 'issort': true,'sort':'desc',id:"total"},
            ];
            $scope.studNavJud = 1;
