...
//          }
        ...
        function routerGo(type) {
            switch(type) {
                case 1: 
                    $state.go('new_organ_financeSummary/finance_infos', {});
                    break;
                case 2: 
                    $state.go('new_organ_financeSummary/business_infos', {});
                    break;
                case 3: 
                    $state.go('new_organ_financeSummary/goods_statistics', {});
                    break;
                case 4: 
                    $state.go('new_organ_financeSummary/used_money_bytime', {});
                    break;
                case 5: 
                    $state.go('new_organ_financeSummary/useing_money_bytime', {});
                    break;
            }
        }
        ...
        function getOverViewData(types, date) {
            ...
            $.hello({
                url: CONFIG.URL + (types==3?"/api/org/statistics/":"/api/oa/statistics/")+setUrl(types),
                type: "get",
                data: params,
