        ...
        function init(){
            ...
            $scope.screen_classType = [
             ...
             $scope.teacListThead = [
                ...
                {'name': '费用支出','width': '10%', 'issort': true,id:"data8"},
...
//              feeExpenditureStr:feeExpenditureStr?feeExpenditureStr:undefined
            ...
            $.hello({
                url: CONFIG.URL + "/api/org/statistics/getBusinessStatistics",
                type: "get",
                data: params,
                success: function(data) {
                    if (data.status == '200') {
        ...
        function export_config() {
            ...
            window.open(CONFIG.URL + '/api/org/statistics/exportBusinessStatistics?' + $.param(params));
        }
        //返回
