...
//             {name:"损耗数量",id:"data7"},
             ...
             $scope.teacListThead = [
                {'name': '校区名称','width': '200px',},
//              {'name': '售卖数量','width': '10%', 'issort': true,id:"data2",},
                {'name': '售卖金额','width': '20%', 'issort': true,id:"data3"},
//              {'name': '退学杂数量','width': '10%', 'issort': true,id:"data5"},
                {'name': '退学杂金额','width': '20%', 'issort': true,id:"data6",},
                {'name': '成本价格','width': '20%', 'issort': true,id:"data4",},
//              {'name': '损耗数量','width': '10%', 'issort': true,id:"data7"},
                {'name': '损耗金额','width': '20%', 'issort': true,id:"data8"},
        ...
        function switchStudNav(n){
            switch (n){
            	case 1:$state.go("new_organ_financeSummary/goods_statistics");
            		break;
            	case 2:$state.go("new_organ_financeSummary/fee_statistics");
            		break;
            	default:
            		break;
            }
        ...
        function changeChart(){
            ...
            $.hello({
                url: CONFIG.URL + "/api/org/statistics/listGoodsStatisticsChart",
                type: "get",
                data: params,
                success: function(data) {
                    if (data.status == '200') {
...
//                  min: 0,
        ...
        function changeTable(){
            ...
            $.hello({
                url: CONFIG.URL + "/api/org/statistics/listGoodsStatistics",
                type: "get",
                data: params,
                success: function(data) {
                    if (data.status == '200') {
        ...
        function export_config() {
            ...
            window.open(CONFIG.URL + '/api/org/statistics/exportGoodsStatistics?' + $.param(params));
        }
        //返回
