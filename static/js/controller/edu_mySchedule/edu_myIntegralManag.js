...
//              0 未开始 1 进行中 2 已结束 3 未结束
            ...
            $.hello({
                url: CONFIG.URL + "/api/oa/homework/listHomeworkRInMyCourse",
                type: "get",
                data: params,
                success: function(data) {
                    if (data.status == 200) {
        ...
        function openClockPop() {
            ...
            function checkClass() {
                window.$rootScope.yznOpenPopUp($scope, 'course-sel', 'choseClass', '1060px', {
                    ...
                    teacherName:window.currentUserInfo.teacherName,
                    name: "class",
                    type: 'checkbox',
            ...
            function confirm_setClock(){
                ...
                var param = {
                    ...
                    classList:getClassList_($scope.clockDetail.classList)
                };
