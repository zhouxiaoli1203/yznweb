(function(window) {
    ...
    !function(global) {
        if (!global.AMap)
            throw new Error("请前置引入高德地图api，参见http://lbs.amap.com/api/javascript-api/gettingstarted/");
    }(window);
    var AMapUI;
    !function() {
        if (!AMapUI || !AMapUI.requirejs) {
            AMapUI ? require = AMapUI : AMapUI = {};
            ...
            !function(global, setTimeout) {
                ...
                function eachProp(e, t) {
                    var r;
                    for (r in e)
                        if (hasProp(e, r) && t(e[r], r))
                            break
                }
                function mixin(e, t, r, n) {
                    return t && eachProp(t, function(t, i) {
                        !r && hasProp(e, i) || (!n || "object" != typeof t || !t || isArray(t) || isFunction(t) || t instanceof RegExp ? e[i] = t : (e[i] || (e[i] = {}),
                            mixin(e[i], t, r, n)))
                    }),
                        e
                }
                ...
                function newContext(e) {
                    ...
                    function r(e, r, n) {
                        var i, o, a, s, u, c, f, p, d, l, h, m, g = r && r.split("/"), v = w.map, x = v && v["*"];
                        if (e && (e = e.split("/"),
                                f = e.length - 1,
                            w.nodeIdCompat && jsSuffixRegExp.test(e[f]) && (e[f] = e[f].replace(jsSuffixRegExp, "")),
                            "." === e[0].charAt(0) && g && (m = g.slice(0, g.length - 1),
                                e = m.concat(e)),
                                t(e),
                                e = e.join("/")),
                            n && v && (g || x)) {
                            ...
                            e: for (s = a.length; s > 0; s -= 1) {
                                if (c = a.slice(0, s).join("/"),
                                        g)
                                    for (u = g.length; u > 0; u -= 1)
                                        if (o = getOwn(v, g.slice(0, u).join("/")),
                                            o && (o = getOwn(o, c))) {
                                            p = o,
                                                d = s;
                                            break e
                                        }
                                !l && x && getOwn(x, c) && (l = getOwn(x, c),
                                    h = s)
                            }
                            !p && l && (p = l,
                                d = h),
                    ...
                    function a(e, t, n, i) {
                        var a, s, u, c, f = null, p = t ? t.name : null, d = e, l = !0, h = "";
                        return e || (l = !1,
                            e = "_@r" + (C += 1)),
                            c = o(e),
                            f = c[0],
                        ...
                        f && (f = r(f, p, i),
                            s = getOwn(k, f)),
                        e && (f ? h = s && s.normalize ? s.normalize(e, function(e) {
                            return r(e, p, i)
                        }) : e.indexOf("!") === -1 ? r(e, p, i) : e : (h = r(e, p, i),
                            c = o(h),
                            f = c[0],
                            h = c[1],
                            n = !0,
                            a = q.nameToUrl(h))),
                            u = !f || s || n ? "" : "_unnormalized" + (T += 1),
                            {
                                prefix: f,
                                name: h,
                                parentMap: t,
                    ...
                    function s(e) {
                        var t = e.id
                            , r = getOwn(M, t);
                        return r || (r = M[t] = new q.Module(e)),
                            r
                    }
                    function u(e, t, r) {
                        var n = e.id
                            , i = getOwn(M, n);
                        !hasProp(k, n) || i && !i.defineEmitComplete ? (i = s(e),
                            i.error && "error" === t ? r(i.error) : i.on(t, r)) : "defined" === t && r(k[n])
                    }
                    function c(e, t) {
                    ...
                    function f() {
                        globalDefQueue.length && (each(globalDefQueue, function(e) {
                            var t = e[0];
                            "string" == typeof t && (q.defQueueMap[t] = !0),
                                O.push(e)
                        }),
                            globalDefQueue = [])
                    }
                    ...
                    function d(e, t, r) {
                        ...
                        e.error ? e.emit("error", e.error) : (t[n] = !0,
                            each(e.depMaps, function(n, i) {
                                var o = n.id
                                    , a = getOwn(M, o);
                                !a || e.depMatched[i] || r[o] || (getOwn(t, o) ? (e.defineDep(i, k[o]),
                                    e.check()) : d(a, t, r))
                            }),
                            r[n] = !0)
                    }
                    function l() {
                        var e, t, r = 1e3 * w.waitSeconds, o = r && q.startTime + r < (new Date).getTime(), a = [], s = [], u = !1, f = !0;
                        if (!x) {
                            if (x = !0,
                                    eachProp(S, function(e) {
                                        var r = e.map
                                            , c = r.id;
                                        if (e.enabled && (r.isDefine || s.push(e),
                                                !e.error))
                                            if (!e.inited && o)
                                                i(c) ? (t = !0,
                                                    u = !0) : (a.push(c),
                                                    n(c));
                                            else if (!e.inited && e.fetched && r.isDefine && (u = !0,
                                                    !r.prefix))
                                                return f = !1
                                    }),
                                o && a.length)
                    ...
                    function h(e) {
                        hasProp(k, e[0]) || s(a(e[0], null, !0)).init(e[1], e[2])
                    }
                    function m(e, t, r, n) {
                        e.detachEvent && !isOpera ? n && e.detachEvent(n, t) : e.removeEventListener(r, t, !1)
                    }
                    function g(e) {
                    ...
                    return y = {
                        ...
                        exports: function(e) {
                            if (e.usingExports = !0,
                                    e.map.isDefine)
                                return e.exports ? k[e.map.id] = e.exports : e.exports = k[e.map.id] = {}
                        },
                        module: function(e) {
                        ...
                        b = function(e) {
                            this.events = getOwn(A, e.id) || {},
                                this.map = e,
                                this.shim = getOwn(w.shim, e.id),
                                this.depExports = [],
                                this.depMaps = [],
                                this.depMatched = [],
                                this.pluginMaps = {},
                        ...
                        b.prototype = {
                            init: function(e, t, r, n) {
                                ...
                                this.inited || (this.factory = t,
                                    r ? this.on("error", r) : this.events.error && (r = bind(this, function(e) {
                                        this.emit("error", e)
                                    })),
                            ...
                            check: function() {
                                if (this.enabled && !this.enabling) {
                                    var e, t, r = this.map.id, n = this.depExports, i = this.exports, o = this.factory;
                                    if (this.inited) {
                                        if (this.error)
                                            ...
                                            if (this.defining = !0,
                                                ...
                                                if (isFunction(o)) {
                                                    if (this.events.error && this.map.isDefine || req.onError !== defaultOnError)
                                                        ...
                                                        i = q.execCb(r, o, n, i);
                                                    if (this.map.isDefine && void 0 === i && (t = this.module,
                                                            t ? i = t.exports : this.usingExports && (i = this.exports)),
                                                            e)
                                                    ...
                                                    i = o;
                                                if (this.exports = i,
                                                    this.map.isDefine && !this.ignore && (k[r] = i,
                                                        req.onResourceLoad)) {
                                                    var a = [];
                                        ...
                                        hasProp(q.defQueueMap, r) || this.fetch()
                                }
                            },
                            callPlugin: function() {
                                var e = this.map
                                    ...
                                    , n = a(e.prefix);
                                this.depMaps.push(n),
                                    u(n, "defined", bind(this, function(n) {
                                        var i, o, f, d = getOwn(I, this.map.id), l = this.map.name, h = this.map.parentMap ? this.map.parentMap.name : null, m = q.makeRequire(e.parentMap, {
                                            enableBuildCallback: !0
                                        });
                                        return this.map.unnormalized ? (n.normalize && (l = n.normalize(l, function(e) {
                                            ...
                                            u(o, "defined", bind(this, function(e) {
                                            ...
                                            f = getOwn(M, o.id),
                                            void (f && (this.depMaps.push(o),
                                            this.events.error && f.on("error", bind(this, function(e) {
                                                this.emit("error", e)
                                            })),
                                                f.enable()))) : d ? (this.map.url = q.nameToUrl(d),
                                            void this.load()) : (i = bind(this, function(e) {
                                            this.init([], function() {
                                                return e
                                            }, null, {
                                                enabled: !0
                                            ...
                                            i.fromText = bind(this, function(r, n) {
                                                var o = e.name
                                                    , u = a(o)
                                                    , f = useInteractive;
                                                n && (r = n),
                                                f && (useInteractive = !1),
                                                    s(u),
                                                hasProp(w.config, t) && (w.config[o] = w.config[t]);
                                                try {
                                                    req.exec(r)
                                                } catch (e) {
                                    ...
                                    each(this.depMaps, bind(this, function(e, t) {
                                        ...
                                        if ("string" == typeof e) {
                                            if (e = a(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap),
                                                    this.depMaps[t] = e,
                                                    i = getOwn(y, e.id))
                                                return void (this.depExports[t] = i(this));
                                            this.depCount += 1,
                                        ...
                                        r = e.id,
                                            n = M[r],
                                        hasProp(y, r) || !n || n.enabled || q.enable(e, this)
                                    })),
                        ...
                        q = {
                            ...
                            makeRequire: function(t, i) {
                                function o(r, n, u) {
                                    var f, p, d;
                                    return i.enableBuildCallback && n && isFunction(n) && (n.__requireJsBuild = !0),
                                        "string" == typeof r ? isFunction(n) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(y, r) ? y[r](M[t.id]) : req.get ? req.get(q, r, t, o) : (p = a(r, t, !1, !0),
                                            f = p.id,
                                            hasProp(k, f) ? k[f] : c(makeError("notloaded", 'Module name "' + f + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (v(),
                                            q.nextTick(function() {
                                                v(),
                                                    d = s(a(null, t)),
                                                    d.skipMap = i.skipMap,
                                ...
                                return i = i || {},
                                    mixin(o, {
                                        isBrowser: isBrowser,
                                        toUrl: function(e) {
                                            var n, i = e.lastIndexOf("."), o = e.split("/")[0], a = "." === o || ".." === o;
                                            return i !== -1 && (!a || i > 1) && (n = e.substring(i, e.length),
                                                e = e.substring(0, i)),
                                                q.nameToUrl(r(e, t && t.id, !0), n, !0)
                                        },
                                        defined: function(e) {
                                            return hasProp(k, a(e, t, !1, !0).id)
                                        },
                                        specified: function(e) {
                                            return e = a(e, t, !1, !0).id,
                                            hasProp(k, e) || hasProp(M, e)
                                        }
                                    }),
                                t || (o.undef = function(e) {
                                        ...
                                        i.undefed = !0,
                                            ...
                                            delete j[r.url],
                                            delete A[e],
                                            eachReverse(O, function(t, r) {
                                                t[0] === e && O.splice(r, 1)
                                            }),
                                            delete q.defQueueMap[e],
                                        i && (i.events.defined && (A[e] = i.events),
                                            p(e))
                                    }
                                ),
                                    o
                            ...
                            completeLoad: function(e) {
                                var t, r, n, o = getOwn(w.shim, e) || {}, a = o.exports;
                                for (f(); O.length; ) {
                                    if (r = O.shift(),
                                        null === r[0]) {
                                        if (r[0] = e,
                                ...
                                if (q.defQueueMap = {},
                                        n = getOwn(M, e),
                                    !t && !hasProp(k, e) && n && !n.inited) {
                                    if (!(!w.enforceDefine || a && getGlobal(a)))
                                        return i(e) ? void 0 : c(makeError("nodefine", "No define call for " + e, null, [e]));
                                    h([e, o.deps || [], o.exportsFn])
                                }
                                l()
                            },
                            nameToUrl: function(e, t, r) {
                                var n, i, o, a, s, u, c, f = getOwn(w.pkgs, e);
                                if (f && (e = f),
                                        c = getOwn(I, e))
                                    return q.nameToUrl(c, t, r);
                                if (req.jsExtRegExp.test(e))
                                    ...
                                    s = i.join("/"),
                                        s += t || (/^data\:|^blob\:|\?/.test(s) || r ? "" : ".js"),
                                        s = ("/" === s.charAt(0) || s.match(/^[\w\+\.\-]+:/) ? "" : w.baseUrl) + s
                                }
                            ...
                            onScriptError: function(e) {
                                ...
                                if (!i(t.id)) {
                                    var r = [];
                                    return eachProp(M, function(e, n) {
                ...
                if ("undefined" == typeof define) {
                    ...
                    "undefined" == typeof require || isFunction(require) || (cfg = require,
                        require = void 0),
                        req = requirejs = function(e, t, r, n) {
                    ...
                    baseElement && (head = s.head = baseElement.parentNode)),
                        ...
                        req.load = function(e, t, r) {
                            var n, i = e && e.config || {};
                            if (isBrowser)
                                return n = req.createNode(i, t, r),
                                    n.setAttribute("data-requirecontext", e.contextName),
                                    n.setAttribute("data-requiremodule", t),
                                    !n.attachEvent || n.attachEvent.toString && n.attachEvent.toString().indexOf("[native code") < 0 || isOpera ? (n.addEventListener("load", e.onScriptLoad, !1),
                                        n.addEventListener("error", e.onScriptError, !1)) : (useInteractive = !0,
                                        n.attachEvent("onreadystatechange", e.onScriptLoad)),
                                    n.src = r,
                                i.onNodeCreated && i.onNodeCreated(n, i, t, r),
                            ...
                            if (isWebWorker)
                                try {
                                    ...
                                    e.onError(makeError("importscripts", "importScripts failed for " + t + " at " + r, n, [t]))
                                }
                        }
                        ,
                    isBrowser && !cfg.skipDataMain && eachReverse(scripts(), function(e) {
                        ...
                        define = function(e, t, r) {
                            ...
                            useInteractive && (n = currentlyAddingScript || getInteractiveScript(),
                            n && (e || (e = n.getAttribute("data-requiremodule")),
                                i = contexts[n.getAttribute("data-requirecontext")])),
                                i ? (i.defQueue.push([e, t, r]),
                                    i.defQueueMap[e] = !0) : globalDefQueue.push([e, t, r])
                        }
                        ,
                        define.amd = {
                            jQuery: !0
                ...
                AMapUI.requirejs = requirejs,
                AMapUI.require = require,
                AMapUI.define = define
        }
    }(),
        AMapUI.define("polyfill/require/require", function() {}),
        AMapUI.define("polyfill/require/require-css/css", [], function() {
            ...
            var e = document.getElementsByTagName("head")[0]
                ...
                , r = !1
                , n = !0;
            t[1] || t[7] ? r = parseInt(t[1]) < 6 || parseInt(t[7]) <= 9 : t[2] || t[8] ? n = !1 : t[4] && (r = parseInt(t[4]) < 18);
            var i = {};
            i.pluginBuilder = "./css-builder";
            var o, a, s, u = function() {
            ...
            return i.normalize = function(e, t) {
                ...
                ,
                i.load = function(e, t, n, i) {
                    (r ? l : h)(t.toUrl(e + ".css"), n)
                }
                ,
                i
        }),
        AMapUI.define("polyfill/require/require-css/normalize", [], function() {
            function e(e, n, i) {
                if (e.match(s) || e.match(a))
                    return e;
                e = o(e);
                var u = i.match(a)
                    , c = n.match(a);
                return !c || u && u[1] == c[1] && u[2] == c[2] ? r(t(e, n), i) : t(e, n)
            }
            function t(e, t) {
                ...
                var r = t.split("/")
                    , n = e.split("/");
                for (r.pop(); curPart = n.shift(); )
                    ".." == curPart ? r.pop() : r.push(curPart);
                return r.join("/")
            }
            function r(e, t) {
                var r = t.split("/");
            ...
            var n = /([^:])\/+/g
                ...
                n = o(n),
                    i = o(i);
                for (var s, u, r, c = /@import\s*("([^"]*)"|'([^']*)')|url\s*\((?!#)\s*(\s*"([^"]*)"|'([^']*)'|[^\)]*\s*)\s*\)/gi; s = c.exec(r); ) {
                    u = s[3] || s[2] || s[5] || s[6] || s[4];
                    var f;
                    f = e(u, n, i),
                    f !== u && a && (f = t(f, a));
                    var p = s[5] || s[6] ? 1 : 0;
                    r = r.substr(0, c.lastIndex - u.length - p - 1) + f + r.substr(c.lastIndex - p - 1),
                        c.lastIndex = c.lastIndex + (f.length - u.length)
                }
                return r
            };
            return u.convertURIBase = e,
                u.absoluteURI = t,
                u.relativeURI = r,
                u
        }),
        AMapUI.define("polyfill/require/require-text/text", ["module"], function(e) {
            "use strict";
            function t(e, t) {
            ...
            function r(e, r, n, i) {
                ...
                if (e === n) {
                    if ("http" === e)
                        return t(r, "80") === t(i, "80");
                    if ("https" === e)
                        return t(r, "443") === t(i, "443")
                }
                return !1
            }
            var n, i, o, a, s, u = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"], c = /^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im, f = /<body[^>]*>\s*([\s\S]+)\s*<\/body>/im, p = "undefined" != typeof location && location.href, d = p && location.protocol && location.protocol.replace(/\:/, ""), l = p && location.hostname, h = p && (location.port || void 0), m = {}, g = e.config && e.config() || {};
            return n = {
                version: "2.0.15",
                strip: function(e) {
                    if (e) {
                ...
                parseName: function(e) {
                    var t, r, n, i = !1, o = e.lastIndexOf("."), a = 0 === e.indexOf("./") || 0 === e.indexOf("../");
                    return o !== -1 && (!a || o > 1) ? (t = e.substring(0, o),
                        r = e.substring(o + 1)) : t = e,
                        n = r || t,
                        o = n.indexOf("!"),
                    o !== -1 && (i = "strip" === n.substring(o + 1),
                        n = n.substring(0, o),
                        r ? r = n : t = n),
                        {
                            moduleName: t,
                ...
                useXhr: function(e, t, i, o) {
                    var a, s, u, c = n.xdRegExp.exec(e);
                    return !c || (a = c[2],
                        s = c[3],
                        s = s.split(":"),
                        u = s[1],
                        s = s[0],
                    (!a || a === t) && (!s || s.toLowerCase() === i.toLowerCase()) && (!u && !s || r(a, u, t, o)))
                },
                ...
                load: function(e, t, r, i) {
                    ...
                    var o = n.parseName(e)
                        ...
                        , s = t.toUrl(a)
                        , u = g.useXhr || n.useXhr;
                    return 0 === s.indexOf("empty:") ? void r() : void (!p || u(s, d, l, h) ? n.get(s, function(t) {
                        n.finishLoad(e, o.strip, t, r)
                    }, function(e) {
                        r.error && r.error(e)
                    }) : t([a], function(e) {
                        n.finishLoad(o.moduleName + "." + o.ext, o.strip, e, r)
                    }))
                },
                write: function(e, t, r, i) {
                    if (m.hasOwnProperty(t)) {
                        var o = n.jsEscape(m[t]);
                        r.asModule(e + "!" + t, "define(function () { return '" + o + "';});\n")
                    }
                },
                writeFile: function(e, t, r, i, o) {
                    var a = n.parseName(t)
                        , s = a.ext ? "." + a.ext : ""
                        , u = a.moduleName + s
                ...
                "node" === g.env || !g.env && "undefined" != typeof process && process.versions && process.versions.node && !process.versions["node-webkit"] && !process.versions["atom-shell"] ? (i = require.nodeRequire("fs"),
                ...
                ) : "xhr" === g.env || !g.env && n.createXhr() ? n.get = function(e, t, r, i) {
                        var o, a = n.createXhr();
                        if (a.open("GET", e, !0),
                                i)
                            for (o in i)
                    ...
                    : "rhino" === g.env || !g.env && "undefined" != typeof Packages && "undefined" != typeof java ? n.get = function(e, t) {
                            var r, n, i = "utf-8", o = new java.io.File(e), a = java.lang.System.getProperty("line.separator"), s = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(o),i)), u = "";
                            try {
                                for (r = new java.lang.StringBuffer,
                                         n = s.readLine(),
                                     n && n.length() && 65279 === n.charAt(0) && (n = n.substring(1)),
                                     null !== n && r.append(n); null !== (n = s.readLine()); )
                                    r.append(a),
                                        r.append(n);
                                u = String(r.toString())
                            } finally {
                        ...
                        : ("xpconnect" === g.env || !g.env && "undefined" != typeof Components && Components.classes && Components.interfaces) && (o = Components.classes,
                            ...
                            n.get = function(e, t) {
                                ...
                                try {
                                    r = o["@mozilla.org/network/file-input-stream;1"].createInstance(a.nsIFileInputStream),
                                        r.init(i, 1, 0, !1),
                                        n = o["@mozilla.org/intl/converter-input-stream;1"].createInstance(a.nsIConverterInputStream),
                                        n.init(r, "utf-8", r.available(), a.nsIConverterInputStream.DEFAULT_REPLACEMENT_CHARACTER),
                                        n.readString(r.available(), u),
                                        n.close(),
                                        r.close(),
                                        t(u.value)
                                } catch (e) {
        ...
        AMapUI.define("polyfill/require/require-json/json", ["text"], function(text) {
            ...
            return {
                load: function(e, t, r, n) {
                    n.isBuild && (n.inlineJSON === !1 || e.indexOf(CACHE_BUST_QUERY_PARAM + "=") !== -1) || 0 === t.toUrl(e).indexOf("empty:") ? r(null) : text.get(t.toUrl(e), function(t) {
                        var i;
                        if (n.isBuild)
                            buildMap[e] = t,
                                r(t);
                ...
                write: function(e, t, r) {
                    if (t in buildMap) {
                        var n = buildMap[t];
                        r('define("' + e + "!" + t + '", function(){ return ' + n + ";});\n")
                    }
                }
            }
        }),
    ...
    AMapUI.define("lib/utils", [], function() {
        ...
        utils = {
            ...
            map: function(array, callback, thisArg) {
                ...
                for (var newArr = [], i = 0, len = array.length; i < len; i++)
                    newArr[i] = callback.call(thisArg, array[i], i);
                return newArr;
            },
                ...
                for (var i = 0, len = objs.length; i < len; i++) {
                    ...
                    if (source)
                        for (var prop in source)
                            source.hasOwnProperty(prop) && (utils.isObject(dst[prop]) && utils.isObject(source[prop]) ? dst[prop] = utils.nestExtendObjs({}, [dst[prop], source[prop]]) : dst[prop] = source[prop]);
                }
                return dst;
            },
            extendObjs: function(dst, objs) {
                ...
                for (var i = 0, len = objs.length; i < len; i++) {
                    ...
                    if (source)
                        for (var prop in source)
                            source.hasOwnProperty(prop) && (dst[prop] = source[prop]);
                }
                return dst;
            },
                ...
                utils.forEach(Array.prototype.slice.call(arguments, 1), function(source) {
                    if (source)
                        for (var i = 0, len = props.length; i < len; i++)
                            source.hasOwnProperty(props[i]) && (sobj[props[i]] = source[props[i]]);
                });
                return sobj;
            },
            ...
            inherit: function(child, parent) {
                ...
                for (var key in parent)
                    parent.hasOwnProperty(key) && (child[key] = parent[key]);
            ...
            throttle: function(func, wait, options) {
                ...
                return function() {
                    ...
                    if (remaining <= 0 || remaining > wait) {
                        ...
                        timeout || options.trailing === !1 || (timeout = setTimeout(later, remaining));
                    return result;
                }
                    ;
            },
    ...
    AMapUI.define("lib/event", ["lib/utils"], function(utils) {
        ...
        utils.extend(Event.prototype, {
            on: function(ev, listener, priority) {
                ...
                evHash[ev] || (evHash[ev] = []);
                var list = evHash[ev]
                    , index = this.__index(list, listener);
                if (index < 0) {
                    "number" != typeof priority && (priority = 10);
                    for (var inps = list.length, i = 0, len = list.length; i < len; i++)
            ...
            __multiCall: function(ev, listener, func) {
                ...
                if (evs && evs.length > 1) {
                    for (var i = 0, len = evs.length; i < len; i++)
                        evs[i] && func.call(this, evs[i], listener);
                    return !0;
                }
                return !1;
            },
    ...
    AMapUI.uiMods = ["ui/control/BasicControl", "ui/geo/DistrictCluster", "ui/geo/DistrictExplorer", "ui/misc/MarkerList", "ui/misc/MobiCityPicker", "ui/misc/PathSimplifier", "ui/misc/PoiPicker", "ui/misc/PointSimplifier", "ui/misc/PointSimplifr", "ui/misc/PositionPicker", "ui/overlay/AwesomeMarker", "ui/overlay/SimpleInfoWindow", "ui/overlay/SimpleMarker", "ui/overlay/SvgMarker"];
    !function(ns, window) {
        ...
        var libConf = ns.libConf
            , reqConf = ns.requireConf
            , uiMods = ns.uiMods || [];
        ...
        ns.findDefinedId = function(test, thisArg) {
            ...
            if (!requirejs.s || !requirejs.s.contexts)
                return null;
            var contexts = requirejs.s.contexts[requireContentName];
            if (!contexts)
                return null;
            var defined = contexts.defined;
            for (var k in defined)
                if (defined.hasOwnProperty(k) && test.call(thisArg, k))
                    return k;
            return null;
        }
        ;
        ...
        ns.defineTpl = function(name) {
            if ("string" != typeof name)
                throw new Error("tpl name is supposed to be a string");
            var args = Array.prototype.slice.call(arguments, 0);
        ...
        ns.inspectDomLibrary = function($) {
            var isJQuery = $.fn && $.fn.jquery
                , isZepto = $ === window.Zepto;
            return {
                isJQuery: !!isJQuery,
                isZepto: isZepto,
