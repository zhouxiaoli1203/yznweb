...
! function($) {
    ...
    var Datepicker = function(element, options) {
        ...
        this.cleanBtn = options.cleanBtn;
		...
		if(this.cleanBtn){
			 this.picker.find('th#clean').show();
		}
        if (this.isInline) {
    ...
    var DPGlobal = {
        ...
        footTemplate: '<tfoot><tr><th colspan="7" class="today"></th><th colspan="7" id="clean" class="clean">清除</th></tr></tfoot>'
    };
